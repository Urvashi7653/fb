...
exports.authUser = async (req, res, next) => {
  try {
    ...
    //The bearer token is a cryptic string, usually generated by the server in response to a login request. (REMEMBER , EVERYTIME WE LOGIN WE CREATED A TOKEN)The client must send this token in the Authorization header when making requests to protected resources.
